...
namespace FactoryStarter.Core {
    public class Game {
        ...
        public void SaveLevel() {
            _dtoRepository.Save(new LevelDto(_level));
        }

        public void RestoreLevel(int id) {
            _level.Restore(_dtoRepository.GetLevel(id));
        }

        public void SetLevelEventHandler(ILevelEventHandler handler) {
            _level.EventHandler = handler;
        }

        public void SetConstructionEventHandler(int id, IConstructionEventHandler handler) {
